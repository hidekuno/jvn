...
<html lang="ja">
  <head>
    ...
    <link href="/jvn/jquery.datetimepicker.css" rel="stylesheet">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu jvn-dropdown-menu">
                <li><a id="jvn_product_summary" class="jvn_menu_btn" href="#">製品別脆弱性件数</a></li>
                <li class="divider jvn-divider"></li>
                <li><a id="jvn_vendor_summary" class="jvn_menu_btn" href="#">ベンダ別脆弱性件数</a></li>
                <li class="divider jvn-divider"></li>
                <li><a id="jvn_barchart" class="jvn_menu_btn" href="#">発生件数(棒グラフ)</a></li>
                <li class="divider jvn-divider"></li>
            ...
            <li><a id="jvn_develop" class="jvn_menu_item jvn_menu_btn" href="#"><span class="glyphicon glyphicon-wrench"></span> 依頼チェック </a></li>
            <li><a id="jvn_account" class="jvn_menu_item jvn_menu_btn" href="#"><span class="glyphicon glyphicon-user"></span>アカウント管理</a></li>
            {% endif %}
