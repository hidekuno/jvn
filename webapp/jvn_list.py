...
class JvnDAO(object):
    ...
    def get_records(self, offset):
        ...
        self.app.cursor.execute(
            sql_main + " " + sql_where + " " + sql_gr, tuple(params)
        )
...
################################################################################
class Index(jvn_pagination.Index, ListLogic):
    pass


class Search(jvn_pagination.Search, ListLogic):
    pass


class Next(jvn_pagination.Next, ListLogic):
    pass


class Prev(jvn_pagination.Prev, ListLogic):
    pass


class Back(jvn_pagination.Back, ListLogic):
    pass
